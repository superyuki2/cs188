...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for lgpd in livingGhostPositionDistributions:
            most_likely = lgpd.argMax()
            distance = self.distancer.getDistance(pacmanPosition, most_likely)
            if distance < closest_dist:
                closest_dist = distance
                closest_pos = most_likely
        ...
        for action in legal:
            ...
            action_dist = self.distancer.getDistance(next_pos, closest_pos)
            if action_dist < closest_dist:
                closest_dist = action_dist
                best_action = action
